...
tantivy is not yet a Pharlux dependency; the V1.1 work will add it through the standard `VERSIONS.md` review process. See [DESIGN.md](https://github.com/Veltara-Works/pharlux/blob/v1.0.0/DESIGN.md) §"Full-text log search" for the design-in note.
