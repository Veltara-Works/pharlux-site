...
- **No email channel in V1.** Email via `lettre` is V1.1; the dependency is already pinned in [`VERSIONS.md`](https://github.com/Veltara-Works/pharlux/blob/v1.1.0/VERSIONS.md).
...
- [`../../adr/0016-background-task-circuit-breaker.md`](https://github.com/Veltara-Works/pharlux/blob/v1.1.0/adr/0016-background-task-circuit-breaker.md) — the original decision record for the circuit-breaker design.
