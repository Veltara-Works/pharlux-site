...
Pharlux's planning memory figure under load is **200–430 MB** (per [ADR-0011](https://github.com/Veltara-Works/pharlux/blob/v1.0.0/adr/0011-memory-budget-200-430mb.md)). The breakdown:
...
- [`../../adr/0011-memory-budget-200-430mb.md`](https://github.com/Veltara-Works/pharlux/blob/v1.0.0/adr/0011-memory-budget-200-430mb.md) — original decision record for the memory accounting.
